// Wrap all initialization code to run after DOM is loaded
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize canvas animation only if canvas exists
    const canvas = document.getElementById("canvas");
    if (canvas) {
        initializeCanvasAnimation();
    }

    // Initialize Femi Voice with delay to ensure all elements are ready
    setTimeout(() => {
...
// Canvas animation function (separated for better organization)
